...
CREATE TABLE IF NOT EXISTS camera (
    ...
    status VARCHAR(32) NOT NULL COMMENT 'online/offline',
...
CREATE TABLE IF NOT EXISTS guard (
    ...
    dingtalk_id VARCHAR(128) NOT NULL COMMENT '钉钉用户标识',
    role VARCHAR(32) NOT NULL COMMENT 'primary/leader',
...
CREATE TABLE IF NOT EXISTS alarm_event (
    ...
    type VARCHAR(32) NOT NULL COMMENT 'intrusion/fire_smoke/occupy/fatigue/fight',
    snapshot_url VARCHAR(256) NOT NULL COMMENT '抓拍图路径',
    face_match VARCHAR(64) NOT NULL COMMENT '会员匹配结果：member:<id>/stranger',
    level INT NOT NULL COMMENT '0=弱提醒(私有)；1=普通；2+=升级、高优先(如打架)',
    status VARCHAR(32) NOT NULL COMMENT 'pending/notified/confirmed/escalated',
